  ...
  return (
    <footer className="bg-dark py-8 text-white">
      <div className="padding-main md:grid-cols-4 grid grid-cols-1 gap-8">
        <FooterBrand />
        <div>
          <h3 className="font-futura mb-4 text-lg uppercase">Shop</h3>
        ...
        <div>
          <h3 className="font-futura mb-4 text-lg uppercase">About</h3>
          <ul className="space-y-2">
            <li>
        ...
        <div>
          <h3 className="font-futura mb-4 text-lg uppercase">Info</h3>
          <ul className="space-y-2">
            <li>
